...
class MainActivity : AppCompatActivity() {
    ...
    class MyAdapter(val data: Array<Data?>, private val view: Int) :
        BaseAdapter() { override fun getCount(): Int { return data.size }
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
            ...
            convertView.imageView.setImageResource(data[position]!!.photo)
            convertView.name.text = data[position]!!.name
            return convertView
        }
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val cubeePhotoIdArray = intArrayOf(R.drawable.cubee1, R.drawable.cubee2, R.drawable.cubee3, R.drawable.cubee4, R.drawable.cubee5,
